    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 px-4 py-8">
      ...
      <div className="relative max-w-md w-full space-y-8 z-10">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20">
                  ...
                  {(error.includes('Usuario no encontrado') || error.includes('Contraseña incorrecta')) && (
                    <div className="mt-3 p-2 bg-white/50 rounded-lg border border-red-200">
                      <p className="text-xs text-red-600">
                        💡 <strong>Sugerencia:</strong> Verifica tus credenciales o usa las cuentas de prueba disponibles
                      </p>
                    </div>
                  )}
          ...
          {/* Demo credentials and quick access */}
          {isLogin && (
            <div className="mt-6 space-y-4">
              <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                <div className="flex items-center justify-between mb-3">
                  <p className="text-sm text-blue-800 font-semibold">🚀 Acceso rápido de prueba</p>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <button
                    type="button"
                    onClick={() => {
                      setEmail('cliente1@example.com');
                      setPassword('123456');
                      setError('');
                    }}
                    className="flex items-center justify-between p-3 bg-white rounded-lg border border-blue-200 hover:border-blue-300 transition-all duration-200 hover:shadow-sm"
                  >
                    <div className="text-left">
                      <p className="text-sm font-medium text-gray-900">👨‍� Cuenta Admin</p>
                      <p className="text-xs text-gray-500">cliente1@example.com</p>
                    </div>
                    <div className="text-xs text-blue-600 font-medium">Usar →</div>
                  </button>
                  ...
                  >
                    <div className="text-left">
                      <p className="text-sm font-medium text-gray-900">👤 Usuario Normal</p>
                      <p className="text-xs text-gray-500">usuario@demo.com</p>
                    </div>
                    <div className="text-xs text-blue-600 font-medium">Usar →</div>
                  </button>
                </div>
                ...
                <div className="mt-3 p-2 bg-amber-50 rounded-lg border border-amber-200">
                  <p className="text-xs text-amber-700">
                    💡 <strong>Tip:</strong> Si es tu primera vez, crea el usuario admin con cliente1@example.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center my-4">
                ...
                <span className="px-4 text-xs text-gray-500 bg-white">o continúa con</span>
                <div className="flex-1 border-t border-gray-200"></div>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all duration-200"
              >
